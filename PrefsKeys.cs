...
namespace TanksMP
{
    ...
    public class PrefsKeys
    {
        ...
        public const string activeBullet = "TM_activeBullet";

        public const string cameradistance = "TM_cameradistance";

        public const string cameraheight = "TM_cameraheight";

        public const string Money = "TM_Money";
    }
}
